...
<body class="font-sans antialiased text-gray-800 bg-white">
    ...
    <section class="py-16 md:py-20 bg-gray-50">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">荣誉资质</h2>
                <p class="text-lg text-gray-600">行业认可，客户信赖</p>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div class="p-6 bg-white rounded-xl border border-gray-100">
                    ...
                    <h3 class="text-sm font-bold text-gray-900">ISO 27001</h3>
                    <p class="text-xs text-gray-500 mt-1">信息安全管理认证</p>
                </div>
                <div class="p-6 bg-white rounded-xl border border-gray-100">
                    ...
                    <h3 class="text-sm font-bold text-gray-900">SOC 2 Type II</h3>
                    <p class="text-xs text-gray-500 mt-1">安全与可用性审计</p>
                </div>
                <div class="p-6 bg-white rounded-xl border border-gray-100">
                    ...
                    <h3 class="text-sm font-bold text-gray-900">国家高新企业</h3>
                    <p class="text-xs text-gray-500 mt-1">国家级高新技术企业认证</p>
                </div>
                <div class="p-6 bg-white rounded-xl border border-gray-100">
                    ...
                    <h3 class="text-sm font-bold text-gray-900">2025 创新产品奖</h3>
                    <p class="text-xs text-gray-500 mt-1">软件授权管理领域年度奖项</p>
                </div>
            </div>
        </div>
    </section>
