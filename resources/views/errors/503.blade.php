...
<head>
    ...
    <title>{{ __('app.errors.503_doc_title') }} - {{ site_setting('site_name', __('app.app_name')) }}</title>
    ...
    <style>
        ...
        .retry-note { font-size:.85rem; color:#a0aec0; margin-top:1rem; }
    </style>
</head>
<body>
    <div class="error-page">
        <div class="error-card">
            ...
            <div class="error-title">{{ __('app.errors.503_title') }}</div>
            <div class="error-desc">{{ __('app.errors.503_message') }}</div>
            <a href="{{ url('/') }}" class="error-btn">{{ __('app.errors.503_retry') }}</a>
            <div class="retry-note">{{ __('app.errors.503_note') }}</div>
        </div>
    </div>
</body>
</html>
