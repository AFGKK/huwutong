...
<head>
    ...
    <title>{{ __('app.errors.403_doc_title') }} - {{ site_setting('site_name', __('app.app_name')) }}</title>
...
<body>
    <div class="error-page">
        <div class="error-card">
            ...
            <div class="error-title">{{ __('app.errors.403_title') }}</div>
            <div class="error-desc">{{ __('app.errors.403_message') }}</div>
