...
/**
 * IM 深链接：account_id 跳转互物号管理，seller_id+product_id 打开卖家私信，conv 打开指定会话
 */
export function useUserChatDeepLink({ startSellerInquiry, selectConversation, conversations, loadConversations }) {
    const route = useRoute()
    const router = useRouter()

    function clearSellerQuery() {
        const nextQuery = { ...route.query }
        delete nextQuery.seller_id
